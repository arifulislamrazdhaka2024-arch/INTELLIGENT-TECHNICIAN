        ...
        <div className="flex items-center justify-between h-16 gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-700 text-xs font-semibold transition-colors"
              title="Install Intelligent Technician PWA on desktop/mobile"
            >
              <Download className="w-3.5 h-3.5 text-blue-400" />
              <span className="hidden sm:inline">{t.downloadApp}</span>
              <span className="sm:hidden text-[10px]">{lang === 'bn' ? 'অ্যাপ' : 'App'}</span>
            </button>
